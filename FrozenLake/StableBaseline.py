...
if __name__ == "__main__":
    ...
    env = gymnasium.make('FrozenLake-v1', is_slippery = False, desc=loaded_map)
    obs, _ = env.reset()
    ...
    env = gymnasium.make('FrozenLake-v1', is_slippery = False, desc=loaded_map, render_mode='human')
    nb_success = 0
    obs, _ = env.reset()
    env.render()
